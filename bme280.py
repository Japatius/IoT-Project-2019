...
def writeFile(temperature,humidity,pressure):
    ...
    try:
        ...
        #client.publish("weather/temp",str(temperature))
...
def main():
    ...
    print("Data of " + str(timestamp))
    print("Temperature : ", temperature, "C")
    print("Pressure    : ", pressure, "hPa")
    print("Humidity    : ", humidity, "%")
#    writeDb(temperature,humidity,pressure)
    writeFile(temperature,humidity,pressure)
